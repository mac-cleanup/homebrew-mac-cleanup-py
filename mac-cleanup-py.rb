class MacCleanupPy < Formula
  ...
  url "https://github.com/mac-cleanup/mac-cleanup-py/archive/refs/tags/v2.2.1.tar.gz"
  sha256 "fa799536b9390a0e815b15e83c2798992498266627516f30efe137361e2fc37f"
  license "Apache-2.0"
